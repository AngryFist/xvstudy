...
class TeacherController extends Controller{
    ...
    public function index(){
        ...
        $this->treeHtml = $this->getTree(D('category')->getTree($this->parentid, 'teacher'));
    ...
    public function getTree($treeArr){
        ...
        if($treeArr){
            ...
            foreach ($treeArr as $value) {
                ...
                $treeHtml .= '<li data-id="'.$value['id'].'">'.$value['name'].' <a href="/Admin/Teacher/index/id/'.$value['id'].'/action/edit" class="ajax">编辑</a>  ';
    ...
    public function getChildren($parent = 0){
        $result = D('category')->getTree($parent, 'teacher');
